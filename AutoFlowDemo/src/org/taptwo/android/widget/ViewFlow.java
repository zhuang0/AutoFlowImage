...
public class ViewFlow extends AdapterView<Adapter> {
	...
	public View getSelectedView() {
		return (mCurrentBufferIndex < mLoadedViews.size()
	...
	public void setSelection(int position) {
		...
		View currentView = makeAndAddView(position, true, (recycleViews.isEmpty()
				? null
		...
		for (int offset = 1; mSideBuffer - offset >= 0; offset++) {
			...
			if (leftIndex >= 0)
				mLoadedViews.addFirst(makeAndAddView(leftIndex, false, (recycleViews.isEmpty()
						? null
						: recycleViews.remove(0))));
			if (rightIndex < mAdapter.getCount())
				mLoadedViews.addLast(makeAndAddView(rightIndex, true, (recycleViews.isEmpty()
						? null
						: recycleViews.remove(0))));
		}
